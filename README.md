...
CentMail is a standalone, self-hosted, newsletter and mailing list manager (based on [listmonk](https://listmonk.app)). It is fast, feature-rich, and packed into a single binary. It uses a PostgreSQL database as its data store.
...
## Developers
CentMail is built on listmonk, which is free and open source software licensed under AGPLv3. If you are interested in contributing, refer to the [developer setup](https://listmonk.app/docs/developer-setup). The backend is written in Go and the frontend is Vue with Buefy for UI. 


## License
CentMail, like the listmonk project it's built on, is licensed under the AGPL v3 license.
